...
const createCalonPemilihValidations = Joi.object({
  ...
  calon_pemilih_kab_kota: Joi.number().required(),
  calon_pemilih_kecamatan: Joi.number().required(),
  calon_pemilih_kelurahan: Joi.number().required(),
...
const updateCalonPemilihValidations = Joi.object({
  ...
  calon_pemilih_kab_kota: Joi.number(),
  calon_pemilih_kecamatan: Joi.number(),
  calon_pemilih_kelurahan: Joi.number(),
